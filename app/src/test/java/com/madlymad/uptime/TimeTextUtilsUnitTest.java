...
public class TimeTextUtilsUnitTest {
    ...
    public void checkTimeConversion() {
        assertEquals(60 * 60 * 1000, TimeTextUtils.convertToMillis(Measure.MEASURE_IN_HOURS, 1));
        assertEquals(24 * 60 * 60 * 1000, TimeTextUtils.convertToMillis(Measure.MEASURE_IN_DAYS, 1));
        assertEquals(30 * 24 * 60 * 60 * 1000L, TimeTextUtils.convertToMillis(Measure.MEASURE_IN_MONTHS, 1));
        assertEquals(12 * 30 * 24 * 60 * 60 * 1000L, TimeTextUtils.convertToMillis(Measure.MEASURE_IN_MONTHS, 12));
    }
}