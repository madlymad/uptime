...
public class TimeTextUtils {
    ...
    static final String GITLAB_PAGES = "https://madlymad.gitlab.io/uptime/";
    ...
    static long convertToMillis(@Measure.TimeMeasurement int measurement, long time) {
        switch (measurement) {
    ...
    static long futureDateForNowAfter(long milliseconds) {
